library flutter_firebase_notification_service;
...
/// A Calculator.
class FlutterFirebaseNotificationService {
  ...
  String? notificationInitialization(FirebaseMessaging messaging){
    ...
    messaging.requestPermission(
      ...
      if (settings.authorizationStatus == AuthorizationStatus.authorized ||
        ...
        debugPrint('**********************Notification Token*************${deviceToken}**************************');
      }
    });
